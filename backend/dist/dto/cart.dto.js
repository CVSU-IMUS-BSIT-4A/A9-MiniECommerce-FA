...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 2, description: 'Quantity to add' }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(1),
    __metadata("design:type", Number)
], AddToCartDto.prototype, "quantity", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'session-123', description: 'Session ID', required: false }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 3, description: 'New quantity' }),
    (0, class_validator_1.IsNumber)(),
