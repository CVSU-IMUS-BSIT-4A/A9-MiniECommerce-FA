...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new order (checkout)' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Order created successfully' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request or insufficient stock' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Order not found' }),
    (0, swagger_1.ApiBody)({ schema: { properties: { status: { type: 'string', example: 'completed' } } } }),
    __param(0, (0, common_1.Param)('id')),
