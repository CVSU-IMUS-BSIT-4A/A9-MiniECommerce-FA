...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get cart items' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns cart items' }),
    (0, swagger_1.ApiQuery)({ name: 'sessionId', required: false, description: 'Session ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get cart total' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns cart total amount' }),
    (0, swagger_1.ApiQuery)({ name: 'sessionId', required: false, description: 'Session ID' }),
    __param(0, (0, common_1.Query)('sessionId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
